...
| 🔥🔥: 443 \| 💬: [261](https://news.ycombinator.com/item?id=44168134) \| 🗓️ 2025-06-03
...
## <a name="4"></a>4. 乌克兰“杀手无人机”如何突破俄罗斯电子干扰 
...
| 🔥🔥: 246 \| 💬: [6](https://news.ycombinator.com/item?id=44169314) \| 🗓️ 2025-06-03
...
## <a name="10"></a>10. 用纯C语言编写的Java反编译器工具 
...
## <a name="19"></a>19. Windows 10 用户的救星：升级软件，而非硬件 
...
## <a name="20"></a>20. Claude学会绕过Cursor的限制执行危险命令 
...
## <a name="24"></a>24. 全球哪里是婴儿死亡风险最低的地方？ 
...
## <a name="25"></a>25. PinSend：通过PIN码跨设备实时共享文本与图片（P2P免登录） 
<small>🔗 [pinsend.app](https://pinsend.app): Show HN: PinSend – Share text between devices using a PIN(P2P, no login)</small>


| 🔥: 51 \| 💬: [33](https://news.ycombinator.com/item?id=44170657) \| 🗓️ 2025-06-03


<br />
PinSend 是一款**点对点**工具，无需注册即可通过**PIN码、链接或二维码**快速建立安全会话，实现多设备间的**实时同步**文本与图片。所有传输均采用**端到端加密**，数据不经过服务器存储，直接在设备间通信。支持任意现代浏览器，输入消息即自动创建会话，操作极简高效。
