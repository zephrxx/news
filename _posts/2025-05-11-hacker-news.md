...
## <a name="13"></a>13. 西班牙叛逆者：玛雅战士贡萨洛·格雷罗 
...
| 🔥: 37 \| 💬: [6](https://news.ycombinator.com/item?id=43953723) \| 🗓️ 2025-05-11


<br />
安全团队Sansec发现，**供应链攻击**导致多个电商软件供应商被入侵，21个流行组件被植入相同后门。该后门早在6年前注入，但近期被激活，攻击者已控制数百家电商服务器（包括一家市值400亿美元的企业）。受影响的组件涉及Tigren、MGS和Meetanshi等厂商，漏洞通过伪造的`License.php`文件执行恶意代码。**建议用户立即检查系统**，移除可疑文件。部分厂商否认被黑，但问题版本仍可下载。
